        ...
        <main style="margin-top: 90px;">
            <div id="content">
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade <?php if ($activeTab === "Dashboardf") echo "show active"; ?>" id="Dashboardf" style="height: 1000px;">
                    ...
                    <div class="tab-pane fade <?php if ($activeTab === "reports") echo "show active"; ?>" id="reports" style="height: 1000px;">
