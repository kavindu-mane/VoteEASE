...
<body>
  ...
  <section style="background-color: #eee; padding-top: 50px">
    <div class="container py-5">
      ...
      <!--nav bar-->
      <!--Variable from Manager Interface-->
      <br>
      <br>
      <br>
      <?php
        ...
        <div class="col-lg-8">
          ...
          <div class="card mb-2">
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-8">
                  <p class="text-muted mb-0"><?php echo $pos ?></p>
                </div>
              </div>
              <hr>
              <div class="row">
              ...
              <div class="row">
                <div class="col-sm-4">
                  <p class="mb-0">Phone Number(Office)</p>
                </div>
                <div class="col-sm-8">
              ...
              <div class="row">
                <div class="col-sm-4">
                  <p class="mb-0">Phone Number(Personal)</p>
                </div>
                <div class="col-sm-8">
                  <p class="text-muted mb-0"><?php echo $pnp ?></p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card mb-2">
            <div class="card-body">
              <div class="row">
                <div class="col-sm-4">
                  <p class="mb-0"><b>Proposal Details</b></p>
                </div>
                <hr>
              </div>
              <div class="row">
